...
import { useClientGetPrivacyPolicyQuery } from "../cmsApi";
...
const PrivacyPolicy = () => {
  ...
  if (isLoading) {
    ...
    const privacyPolicyData = data.getPrivacyPolicyData[0];
    content = (
      <div className="container mt-xl-5">
        <div className="CmsHdd text-center mb-5 ">
          <h4 className="text-white">{privacyPolicyData.title}</h4>
        </div>
